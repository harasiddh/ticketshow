...
db_path = os.path.join(db_directory, 'testdb.sqlite3')
conn = sqlite3.connect(db_path)
cursor = conn.cursor()

# Execute the SQL code to create the database tables and trigger
create_table_and_trigger_sql = '''
...
cursor.executescript(create_table_and_trigger_sql)

# Commit the changes and close the connection
conn.commit()
conn.close()

print(f"Database 'testdb.sqlite3' created in '{db_directory}' directory.")
